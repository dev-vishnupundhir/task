<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <!-- END PAGE BAR -->
        <!-- BEGIN PAGE TITLE-->
        <h3 class="page-title"> Add Countries  </h3>
        <!-- END PAGE TITLE-->
        <div class="portlet box purple">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-cogs"></i>Add Countries  </div>
            ...
            <div class="portlet-body">
                <div clss="col-md-12">
                    <div class="row">
                        <div class="col-md-12" >
                            <form method="post" id="edit_plan" role="form" action="<?php echo HTTP_ROOT.'admin/users/addCountry' ?>">
                            <!-- <input type="hidden" name="Countries[id]"  class="form-control" value="<?php if(isset($country['id']) && !empty($country['id'])){ echo $country['id'];} ?>"/> -->
                                <div class="form-group">
                                    ...
                                    <input type="text" id="countryName" name="Countries[country_name]" placeholder="Country Name" maxlength="50" class="form-control" />
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="ctryurl" name="Countries[country_url]" placeholder="Country Url" class="form-control" />
                                    <div class="custom-error-div">
                                ...
                                <div class="margiv-top-10">
                                    ...
                                    <?php //echo $this->Form->submit(__('Submit'), array('class'=>'btn green-haze', 'div'=>false, 'label'=>false,'id'=>'text', 'onclick'=>'return ajax_form_id("edit_plan", "validation/validateaddCountryAjax")'));?> 
                                </div>
                            </form>
                        </div>
                    </div>
