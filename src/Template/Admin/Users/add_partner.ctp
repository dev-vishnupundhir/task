...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <!-- END PAGE BAR -->
        <!-- BEGIN PAGE TITLE-->
        <h3 class="page-title"> Add Partner </h3>
        <!-- END PAGE TITLE-->
        <div class="portlet box purple">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-cogs"></i>Add Partner </div>
            ...
            <div class="portlet-body">
                <div clss="col-md-12">
                    <div class="row">
                        <div class="col-md-12" >
                            <form method="post" id="add_testimonial" role="form" enctype="multipart/form-data" action="<?php echo HTTP_ROOT.'admin/users/addPartner' ?>">
