    ...
    <div class="page-content">
        ...
        <div class="portlet box purple">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-cogs"></i>Add State  </div>
            ...
            <div class="portlet-body">
                <div clss="col-md-12">
                    <div class="row">
                        <div class="col-md-12" >
                            <form method="post" id="edit_plan" role="form" action="<?php echo HTTP_ROOT.'admin/users/addState' ?>">
                            <!-- <input type="hidden" name="Countries[id]"  class="form-control" value="<?php if(isset($country['id']) && !empty($country['id'])){ echo $country['id'];} ?>"/> -->
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="States[state_name]" placeholder="State Name" class="form-control" />
                                    <div class="custom-error-div">
                                ...
                                <div class="margiv-top-10">
                                    <?php echo $this->Form->submit(__('Submit'), array('class'=>'btn green-haze', 'div'=>false, 'label'=>false,'id'=>'text', 'onclick'=>'return ajax_form_id("edit_plan", "validation/validateaddStateAjax")'));?> 
                                </div>
                            </form>
                        </div>
                    </div>
