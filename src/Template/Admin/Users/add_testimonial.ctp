...
<div class="page-content-wrapper">
    ...
    <div class="page-content">
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    ...
                    <a href="<?php echo HTTP_ROOT . 'admin/users/clientTestimonial/' ?>">Client Testimonial Managements </a>
                    <i class="fa fa-angle-right" aria-hidden="true"></i>
                </li>
                
                <li>
                    <span>Add Client Testimonials</span>
                </li>
        ...
        <!-- END PAGE BAR -->
        <!-- BEGIN PAGE TITLE-->
        <h3 class="page-title"> Add Client Testimonials </h3>
        <!-- END PAGE TITLE-->
        <div class="portlet box purple">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-cogs"></i>Add Client Testimonials </div>
            ...
            <div class="portlet-body">
                <div clss="col-md-12">
                    <div class="row">
                        <div class="col-md-12" >
                            <form method="post" id="add_testimonial" role="form" enctype="multipart/form-data" action="<?php echo HTTP_ROOT.'admin/users/addTestimonial' ?>">
                                <div class="form-group">
                                    <label class="control-label">Section :</label>
                                    <input type="text" name="ClientTestimonials[section]" placeholder="Section" maxlength="30" class="form-control" "/>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="ClientTestimonials[name]" placeholder="Name" maxlength="30" class="form-control"/>
                                    <div class="custom-error-div">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="ClientTestimonials[description]"  placeholder="Description" class="form-control"> </textarea>
                                    <div class="custom-error-div">
                                ...
                                <div class="margiv-top-10">
                                    <?php echo $this->Form->submit(__('Submit'), array('class'=>'btn green-haze', 'div'=>false, 'label'=>false,'id'=>'text', 'onclick'=>'return ajax_form_id("add_testimonial", "validation/validateaddTestimonialAjax")'));?> 
                                </div>
                            </form>
                        </div>
                    </div>
