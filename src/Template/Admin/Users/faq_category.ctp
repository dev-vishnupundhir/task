    ...
    <div class="page-content">        
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <span>Frequently Asked Questions Category</span>
                </li>
            </ul>
        </div>
        <?php echo $this->Flash->render(); ?>
        <h3 class="page-title"> Frequently Asked Questions Category</h3>
        <div class="portlet box purple">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-cogs"></i>Frequently Asked Questions Category
                </div>
                <a onclick="history.go(-1);" href="<?php echo HTTP_ROOT.'admin/users/addFaqCategory' ?>">
                        ...
                        <table class="table table-striped table-bordered table-hover">
                            <thead>
                                ...
                                <tr role="row" class="fliter2">
                                  <form id="f1" method="GET" action="<?php echo HTTP_ROOT.'admin/users/faqCategory'?>">
                                    <td></td>
                                    <td>
                                    ...
                                    <td style="text-align: center;">
                                      <div class="margin-bottom-5">
                                        ...
                                        <a href="<?php echo HTTP_ROOT.'admin/users/faqCategory';?>" class="btn btn-sm red filter-cancel margin-top-10"><i title="Reset" class="fa fa-refresh"></i></a>
                                        ...
                                        <tr> 
                                            ...
                                            <td style="text-align: center;"> 
                                                <?php $id = $this->Utility->encode($list['id']); ?>
                                                 <a title="Edit"  class="btn btn-sm blue margin-top-10" href="<?php echo HTTP_ROOT.'admin/users/editFaqCategory/'.$id;?>"> <i class="fa fa-edit"></i>
                                                </a>
                                                 <a title="Delete"   class="btn btn-sm red margin-top-10 genrate" rel="<?php echo $id; ?>"  href="javascript:void(0)"> <i class="fa fa-trash"></i>
                                                </a>
                                                <span class="tab" rel="FaqCategories"></span>
