<div class="page-content-wrapper">
    ...
    <div class="page-content">
        ...
        <h3 class="page-title">Team Member Management</h3>
        <!-- END PAGE TITLE-->
        <div class="portlet box purple">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-cogs"></i>Team Member Management
                </div>
            ...
            <div class="portlet-body">
                ...
                <tbody>
                    ...
                    <td> <?php echo substr($abouts['name'],0,40) ;?></td>
                    <td> <?php echo substr($abouts['designation'],0,40) ;?></td>
                    <td>  <?php echo substr($abouts['description'],0,100);?></td>
                    
                    <td>  <img src="<?php if(!empty($abouts['image']) && file_exists('img/teamImg/'.$abouts['image'])){echo HTTP_ROOT.'img/teamImg/'.$abouts['image'];}else{echo HTTP_ROOT.'img/staticImage/upld.png';}?>" width = "90px"height="120px"></td>
                    <td> 
                        <?php $checked="";
                    ...
                    <td style="text-align: center;"> 
                        <a title="Edit"  class="btn btn-sm blue margin-top-10" href="<?php echo HTTP_ROOT.'admin/users/editOurTeam/'.$id;?>"> <i class="fa fa-edit"></i>
                        </a>
                    </td>
                </tbody>
                    <?php $i++;} } ?>
