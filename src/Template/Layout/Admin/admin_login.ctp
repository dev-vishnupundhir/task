...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title><?= $title ?> | Style Brigade</title>
    ...
    <body class="login">
        ...
        <!-- BEGIN COPYRIGHT -->
        <div class="copyright"> <?php echo date('Y'); ?> &copy; Style Brigade - Admin Dashboard </div>
        <!-- END COPYRIGHT -->
        <!--[if lt IE 9]>
	...
	<script src="<?php echo HTTP_ROOT ?>js/common/common.js" type="text/javascript"></script>
        ...
        <!-- <script src="<?php echo HTTP_ROOT ?>assets/pages/scripts/login-4.js" type="text/javascript"></script> -->
        <!-- <script src="<?php echo HTTP_ROOT ?>js/common/ajax_form_function.js" type="text/javascript"></script> -->
